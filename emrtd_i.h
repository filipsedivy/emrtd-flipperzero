...
struct Emrtd {
    ...
    /*
     * Whether the credentials are kept in emrtd.settings between runs. On by
     * default: the card is the only place they survive the application being
     * closed, and Document - Forget stored data is how they go.
     */
